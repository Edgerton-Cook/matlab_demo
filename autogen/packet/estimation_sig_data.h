////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/packet/estimation_sig_data.h                                                  //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_PACKET_ESTIMATION_SIG_DATA_H
#define AUTOGEN_PACKET_ESTIMATION_SIG_DATA_H
...
namespace autogen {
  namespace packet {
    class estimation_sig_data : public network::packet {
      public:
        gnc::matrix<float,3,1> pos_ned;
        gnc::matrix<float,3,1> vel_ned;
        gnc::quat q_i2b;
        gnc::matrix<float,3,1> b_accl;
        gnc::matrix<float,3,1> b_gyro;
        gnc::matrix<float,3,1> accl_b;
        gnc::matrix<float,3,1> omega_b;
