////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/packet/mpu6000_local_data.h                                                   //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_PACKET_MPU6000_LOCAL_DATA_H
#define AUTOGEN_PACKET_MPU6000_LOCAL_DATA_H
...
namespace autogen {
  namespace packet {
    class mpu6000_local_data : public network::packet {
      public:
        float inv_accl_scale;
        float inv_gyro_scale;
        bool calibration_complete;
        uint32 i_calib_sample;
        gnc::matrix<float,3,1> accl_bias_sum;
        gnc::matrix<float,3,1> gyro_bias_sum;
        gnc::dcm C_dev2body;
