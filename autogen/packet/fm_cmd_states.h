////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/packet/fm_cmd_states.h                                                        //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_PACKET_FM_CMD_STATES_H
#define AUTOGEN_PACKET_FM_CMD_STATES_H
...
namespace autogen {
  namespace packet {
    class fm_cmd_states : public network::packet {
      public:
        autogen::state::edison_state edison;
        autogen::state::mpu6000_state mpu6000;
        autogen::state::hmc5883l_state hmc5883l;
        autogen::state::neom8_state neom8;
        autogen::state::max11644eua_state max11644eua;
        autogen::state::power_state power;
        autogen::state::led_state led;
        autogen::state::estimation_state estimation;
        autogen::state::qcontrol_state qcontrol;
        autogen::state::rcontrol_state rcontrol;
        autogen::state::sc18is602b_state sc18is602b;
        autogen::state::pca9685_state pca9685;
