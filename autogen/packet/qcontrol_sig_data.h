////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/packet/qcontrol_sig_data.h                                                    //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_PACKET_QCONTROL_SIG_DATA_H
#define AUTOGEN_PACKET_QCONTROL_SIG_DATA_H
...
namespace autogen {
  namespace packet {
    class qcontrol_sig_data : public network::packet {
      public:
        float clock_ref;
        gnc::matrix<float,3,1> pos_ref_ned;
        gnc::matrix<float,3,1> vel_ref_ned;
        gnc::matrix<float,3,1> accl_ref_ned;
        gnc::quat q_i2r;
        gnc::matrix<float,3,1> omega_r;
        gnc::matrix<float,3,1> tau_r;
        gnc::matrix<float,4,1> w_req;
        gnc::matrix<float,4,1> w_alloc;
        gnc::matrix<float,4,1> f_alloc;
        gnc::matrix<float,4,1> u;
