////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/packet/traj6dof.h                                                             //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_PACKET_TRAJ6DOF_H
#define AUTOGEN_PACKET_TRAJ6DOF_H
...
namespace autogen {
  namespace packet {
    class traj6dof : public network::packet {
      public:
        uint64 epoch;
        uint32 is_new;
        uint32 loop;
        uint32 K;
        gnc::matrix<float,1,50> time;
        gnc::matrix<float,3,50> pos_ned;
        gnc::matrix<float,3,50> vel_ned;
        gnc::matrix<float,3,50> accl_ned;
        gnc::matrix<float,3,50> omega_body;
        gnc::matrix<float,3,50> torque_body;
        gnc::matrix<float,1,50> clock_angle;
