////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/packet/estimation_local_data.h                                                //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_PACKET_ESTIMATION_LOCAL_DATA_H
#define AUTOGEN_PACKET_ESTIMATION_LOCAL_DATA_H
...
namespace autogen {
  namespace packet {
    class estimation_local_data : public network::packet {
      public:
        gnc::matrix<float,7,1> x;
        gnc::matrix<float,3,1> gyro_bias_integral;
        gnc::matrix<float,3,1> previous_mag_vec_meas;
        gnc::matrix<float,6,1> x_kf;
        gnc::matrix<float,6,6> P_kf;
