////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/packet/telemetry.h                                                            //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_PACKET_TELEMETRY_H
#define AUTOGEN_PACKET_TELEMETRY_H
...
namespace autogen {
  namespace packet {
    class telemetry : public network::packet {
      public:
        autogen::state::veh_config_state veh_config;
        autogen::state::ownership_state ownership;
        autogen::state::fm_state fm_state;
        autogen::state::qcontrol_mode qcontrol_mode;
        autogen::state::rcontrol_mode rcontrol_mode;
        float battery_voltage;
        gnc::quat q_i2b;
        gnc::quat q_i2r;
        gnc::matrix<float,3,1> pos_ned;
        gnc::matrix<float,3,1> pos_ref_ned;
        gnc::matrix<float,3,1> vel_ned;
        gnc::matrix<float,3,1> accl_b;
        uint16 gps_nsv;
        uint16 gps_fix;
