////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/state/sc18is602b_state.h                                                      //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_STATE_SC18IS602B_STATE_H
#define AUTOGEN_STATE_SC18IS602B_STATE_H
...
namespace autogen {
  namespace state {
    class sc18is602b_state : public network::state {
      public:
        enum STATE_T {
          IDLE,
          INITIALIZE,
        ...
        class state_machine {
          ...
          public:
            ...
            state_machine(const std::string& name, const sc18is602b_state& s);
            ~state_machine();
            ...
            void update(const sc18is602b_state& ref_state);
        };
      ...
      public:
        ...
        sc18is602b_state& operator=(STATE_T rhs);
        bool operator==(const sc18is602b_state& rhs) const;
