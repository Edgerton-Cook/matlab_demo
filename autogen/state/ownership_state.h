////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/state/ownership_state.h                                                       //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_STATE_OWNERSHIP_STATE_H
#define AUTOGEN_STATE_OWNERSHIP_STATE_H
...
namespace autogen {
  namespace state {
    class ownership_state : public network::state {
      public:
        enum STATE_T {
          NOT_OWNED,
          OWNED_BY_THIS_GCS,
        ...
        class state_machine {
          ...
          public:
            ...
            state_machine(const std::string& name, const ownership_state& s);
            ~state_machine();
            ...
            void update(const ownership_state& ref_state);
        };

      protected:
        static const bool s_transitions[3][3];
      ...
      public:
        ...
        ownership_state& operator=(STATE_T rhs);
        bool operator==(const ownership_state& rhs) const;
