////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/state/mpu6000_state.h                                                         //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_STATE_MPU6000_STATE_H
#define AUTOGEN_STATE_MPU6000_STATE_H
...
namespace autogen {
  namespace state {
    class mpu6000_state : public network::state {
      public:
        enum STATE_T {
          IDLE,
          INITIALIZE,
        ...
        class state_machine {
          ...
          public:
            ...
            state_machine(const std::string& name, const mpu6000_state& s);
            ~state_machine();
            ...
            void update(const mpu6000_state& ref_state);
        };
      ...
      public:
        ...
        mpu6000_state& operator=(STATE_T rhs);
        bool operator==(const mpu6000_state& rhs) const;
