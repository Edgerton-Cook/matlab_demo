////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/state/estimation_state.h                                                      //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_STATE_ESTIMATION_STATE_H
#define AUTOGEN_STATE_ESTIMATION_STATE_H
...
namespace autogen {
  namespace state {
    class estimation_state : public network::state {
      public:
        enum STATE_T {
          IDLE,
          INITIALIZE,
        ...
        class state_machine {
          ...
          public:
            ...
            state_machine(const std::string& name, const estimation_state& s);
            ~state_machine();
            ...
            void update(const estimation_state& ref_state);
        };

      protected:
        static const bool s_transitions[5][5];
      ...
      public:
        ...
        estimation_state& operator=(STATE_T rhs);
        bool operator==(const estimation_state& rhs) const;
