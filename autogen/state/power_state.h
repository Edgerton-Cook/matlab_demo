////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/state/power_state.h                                                           //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_STATE_POWER_STATE_H
#define AUTOGEN_STATE_POWER_STATE_H
...
namespace autogen {
  namespace state {
    class power_state : public network::state {
      public:
        enum STATE_T {
          IDLE,
          INITIALIZE,
        ...
        class state_machine {
          ...
          public:
            ...
            state_machine(const std::string& name, const power_state& s);
            ~state_machine();
            ...
            void update(const power_state& ref_state);
        };
      ...
      public:
        ...
        power_state& operator=(STATE_T rhs);
        bool operator==(const power_state& rhs) const;
