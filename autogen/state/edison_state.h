////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/state/edison_state.h                                                          //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_STATE_EDISON_STATE_H
#define AUTOGEN_STATE_EDISON_STATE_H
...
namespace autogen {
  namespace state {
    class edison_state : public network::state {
      public:
        enum STATE_T {
          IDLE,
          INITIALIZE,
        ...
        class state_machine {
          ...
          public:
            ...
            state_machine(const std::string& name, const edison_state& s);
            ~state_machine();
            ...
            void update(const edison_state& ref_state);
        };
      ...
      public:
        ...
        edison_state& operator=(STATE_T rhs);
        bool operator==(const edison_state& rhs) const;
