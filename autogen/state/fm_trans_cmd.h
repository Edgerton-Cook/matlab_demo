////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/state/fm_trans_cmd.h                                                          //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_STATE_FM_TRANS_CMD_H
#define AUTOGEN_STATE_FM_TRANS_CMD_H
...
namespace autogen {
  namespace state {
    class fm_trans_cmd : public network::state {
      public:
        enum STATE_T {
          NOTHING,
          RUN,
        ...
        class state_machine {
          ...
          public:
            ...
            state_machine(const std::string& name, const fm_trans_cmd& s);
            ~state_machine();
            ...
            void update(const fm_trans_cmd& ref_state);
        };
      ...
      public:
        ...
        fm_trans_cmd& operator=(STATE_T rhs);
        bool operator==(const fm_trans_cmd& rhs) const;
