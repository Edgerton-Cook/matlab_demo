////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/state/rcontrol_state.h                                                        //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_STATE_RCONTROL_STATE_H
#define AUTOGEN_STATE_RCONTROL_STATE_H
...
namespace autogen {
  namespace state {
    class rcontrol_state : public network::state {
      public:
        enum STATE_T {
          IDLE,
          INITIALIZE,
        ...
        class state_machine {
          ...
          public:
            ...
            state_machine(const std::string& name, const rcontrol_state& s);
            ~state_machine();
            ...
            void update(const rcontrol_state& ref_state);
        };
      ...
      public:
        ...
        rcontrol_state& operator=(STATE_T rhs);
        bool operator==(const rcontrol_state& rhs) const;
