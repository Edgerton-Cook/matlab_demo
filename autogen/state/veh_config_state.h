////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/state/veh_config_state.h                                                      //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_STATE_VEH_CONFIG_STATE_H
#define AUTOGEN_STATE_VEH_CONFIG_STATE_H
...
namespace autogen {
  namespace state {
    class veh_config_state : public network::state {
      public:
        enum STATE_T {
          INDOOR_ROVER,
          INDOOR_QUAD,
        ...
        class state_machine {
          ...
          public:
            ...
            state_machine(const std::string& name, const veh_config_state& s);
            ~state_machine();
            ...
            void update(const veh_config_state& ref_state);
        };
      ...
      public:
        ...
        veh_config_state& operator=(STATE_T rhs);
        bool operator==(const veh_config_state& rhs) const;
