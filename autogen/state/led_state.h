////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/state/led_state.h                                                             //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_STATE_LED_STATE_H
#define AUTOGEN_STATE_LED_STATE_H
...
namespace autogen {
  namespace state {
    class led_state : public network::state {
      public:
        enum STATE_T {
          IDLE,
          INITIALIZE,
        ...
        class state_machine {
          ...
          public:
            ...
            state_machine(const std::string& name, const led_state& s);
            ~state_machine();
            ...
            void update(const led_state& ref_state);
        };
      ...
      public:
        ...
        led_state& operator=(STATE_T rhs);
        bool operator==(const led_state& rhs) const;
