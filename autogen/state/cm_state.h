////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/state/cm_state.h                                                              //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_STATE_CM_STATE_H
#define AUTOGEN_STATE_CM_STATE_H
...
namespace autogen {
  namespace state {
    class cm_state : public network::state {
      public:
        enum STATE_T {
          INITIALIZE,
          DISCONNECTED,
        ...
        class state_machine {
          ...
          public:
            ...
            state_machine(const std::string& name, const cm_state& s);
            ~state_machine();
            ...
            void update(const cm_state& ref_state);
        };
      ...
      public:
        ...
        cm_state& operator=(STATE_T rhs);
        bool operator==(const cm_state& rhs) const;
