////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/state/neom8_state.h                                                           //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_STATE_NEOM8_STATE_H
#define AUTOGEN_STATE_NEOM8_STATE_H
...
namespace autogen {
  namespace state {
    class neom8_state : public network::state {
      public:
        enum STATE_T {
          IDLE,
          INITIALIZE,
        ...
        class state_machine {
          ...
          public:
            ...
            state_machine(const std::string& name, const neom8_state& s);
            ~state_machine();
            ...
            void update(const neom8_state& ref_state);
        };
      ...
      public:
        ...
        neom8_state& operator=(STATE_T rhs);
        bool operator==(const neom8_state& rhs) const;
