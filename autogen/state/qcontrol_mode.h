////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/state/qcontrol_mode.h                                                         //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_STATE_QCONTROL_MODE_H
#define AUTOGEN_STATE_QCONTROL_MODE_H
...
namespace autogen {
  namespace state {
    class qcontrol_mode : public network::state {
      public:
        enum STATE_T {
          SAFETIED,
          STANDBY,
        ...
        class state_machine {
          ...
          public:
            ...
            state_machine(const std::string& name, const qcontrol_mode& s);
            ~state_machine();
            ...
            void update(const qcontrol_mode& ref_state);
        };

      protected:
        static const bool s_transitions[9][9];
      ...
      public:
        ...
        qcontrol_mode& operator=(STATE_T rhs);
        bool operator==(const qcontrol_mode& rhs) const;
