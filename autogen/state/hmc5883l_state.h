////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/state/hmc5883l_state.h                                                        //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_STATE_HMC5883L_STATE_H
#define AUTOGEN_STATE_HMC5883L_STATE_H
...
namespace autogen {
  namespace state {
    class hmc5883l_state : public network::state {
      public:
        enum STATE_T {
          IDLE,
          INITIALIZE,
        ...
        class state_machine {
          ...
          public:
            ...
            state_machine(const std::string& name, const hmc5883l_state& s);
            ~state_machine();
            ...
            void update(const hmc5883l_state& ref_state);
        };
      ...
      public:
        ...
        hmc5883l_state& operator=(STATE_T rhs);
        bool operator==(const hmc5883l_state& rhs) const;
