////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/state/pca9685_state.h                                                         //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_STATE_PCA9685_STATE_H
#define AUTOGEN_STATE_PCA9685_STATE_H
...
namespace autogen {
  namespace state {
    class pca9685_state : public network::state {
      public:
        enum STATE_T {
          IDLE,
          INITIALIZE,
        ...
        class state_machine {
          ...
          public:
            ...
            state_machine(const std::string& name, const pca9685_state& s);
            ~state_machine();
            ...
            void update(const pca9685_state& ref_state);
        };

      protected:
        static const bool s_transitions[8][8];
      ...
      public:
        ...
        pca9685_state& operator=(STATE_T rhs);
        bool operator==(const pca9685_state& rhs) const;
