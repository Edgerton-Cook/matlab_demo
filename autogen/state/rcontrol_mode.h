////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/state/rcontrol_mode.h                                                         //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_STATE_RCONTROL_MODE_H
#define AUTOGEN_STATE_RCONTROL_MODE_H
...
namespace autogen {
  namespace state {
    class rcontrol_mode : public network::state {
      public:
        enum STATE_T {
          SAFETIED,
          STANDBY,
        ...
        class state_machine {
          ...
          public:
            ...
            state_machine(const std::string& name, const rcontrol_mode& s);
            ~state_machine();
            ...
            void update(const rcontrol_mode& ref_state);
        };

      protected:
        static const bool s_transitions[6][6];
      ...
      public:
        ...
        rcontrol_mode& operator=(STATE_T rhs);
        bool operator==(const rcontrol_mode& rhs) const;
