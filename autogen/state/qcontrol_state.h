////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/state/qcontrol_state.h                                                        //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_STATE_QCONTROL_STATE_H
#define AUTOGEN_STATE_QCONTROL_STATE_H
...
namespace autogen {
  namespace state {
    class qcontrol_state : public network::state {
      public:
        enum STATE_T {
          IDLE,
          INITIALIZE,
        ...
        class state_machine {
          ...
          public:
            ...
            state_machine(const std::string& name, const qcontrol_state& s);
            ~state_machine();
            ...
            void update(const qcontrol_state& ref_state);
        };
      ...
      public:
        ...
        qcontrol_state& operator=(STATE_T rhs);
        bool operator==(const qcontrol_state& rhs) const;
