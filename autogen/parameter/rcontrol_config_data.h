////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/parameter/rcontrol_config_data.h                                              //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_PARAMETER_RCONTROL_CONFIG_DATA_H
#define AUTOGEN_PARAMETER_RCONTROL_CONFIG_DATA_H
...
namespace autogen {
  namespace parameter {
    class rcontrol_config_data : public network::parameter {
      public:
        float test_mode_base_pwm;
        float test_mode_delta_pwm;
        float ol_base_pwm;
        float ol_delta_pwm;
        float cl_base_pwm;
        float cl_max_vel;
        float cl_max_ang_rate_dps;
        float cl_kp_pos;
        float cl_kp_hdg;
        float cl_u_vf_sat;
        float cl_u_vs_sat;
