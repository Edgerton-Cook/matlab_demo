////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/parameter/gcs_agent_config_data.h                                             //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_PARAMETER_GCS_AGENT_CONFIG_DATA_H
#define AUTOGEN_PARAMETER_GCS_AGENT_CONFIG_DATA_H
...
namespace autogen {
  namespace parameter {
    class gcs_agent_config_data : public network::parameter {
      public:
        float rover_min_battery_voltage;
        float rover_max_battery_voltage;
        float quadrotor_min_battery_voltage;
        float quadrotor_max_battery_voltage;
        uint32 pix_margin;
        float southwest_pos_n;
        float southwest_pos_e;
        float northeast_pos_n;
        float northeast_pos_e;
        bool display_text;
