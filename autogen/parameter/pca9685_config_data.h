////////////////////////////////////////////////////////////////////////////////////////////////////
// TITLE:   autogen/parameter/pca9685_config_data.h                                               //
// AUTHOR:  Miki Szmuk                                                                            //
// LAB:     Autonomous Controls Lab (ACL)                                                         //
// LICENSE: Copyright 2016, 2017, All Rights Reserved                                             //
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef AUTOGEN_PARAMETER_PCA9685_CONFIG_DATA_H
#define AUTOGEN_PARAMETER_PCA9685_CONFIG_DATA_H
...
namespace autogen {
  namespace parameter {
    class pca9685_config_data : public network::parameter {
      public:
        float min_pwm[16];
        float max_pwm[16];
        float update_rate;
        float calib_update_rate;
        uint8 calib_ch;
        uint32 n_calib_samples;
        float nominal_calib_pwm;
        float pwm_dlpf_factor;
        float pwm_meas_outlier_margin;
